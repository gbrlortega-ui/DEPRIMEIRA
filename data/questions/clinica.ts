...
export const clinicaQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Solicitar novo VDRL e, se positivo, indicar le tratamento.'
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      'Teste rápido sorológico de detecção de anticorpos circulantes.',
      'ELISA de 4ª geração (antígeno p24 + anticorpos).',
      'Contagem de linfócitos T CD4+.',
      'Western blot de detecção de anticorpos circulantes.'
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Dessensibilização dos auto-receptores à serotonina sináptica elevada.',
      'Aumento do armazenamento de serotonina nas vesículas pré-sinápticas.',
      'Diminuição da sensibilidade dos receptores pós-sinápticos.',
      'Aumento da captação de triptofano para síntese de serotonina.'
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'Glomerulonefrite aguda inflamatória.',
      'Síndrome nefrótica por lesão glomerular.',
      'Nefropatia por AINEs (vasoconstrição renal por inibição de prostaglandinas).',
      'Nefropatia diabética crônica.'
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      'Leishmaniose tegumentar, forma cutânea difusa; formas promastigotas.',
      'Leishmaniose tegumentar, forma cutaneomucosa; formas paramastigotas.',
      'Leishmaniose tegumentar, forma cutânea; formas amastigotas intracelulares.',
      'Leishmaniose tegumentar, forma mucosa; formas amastigotas intracelulares.'
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      'Traço falcêmico, com 25% de risco.',
      'Anemia falciforme, com 50% de risco.',
      'Anemia falciforme, sem risco para le bebê.'
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      'Detecção de anticorpos contra antígenos autólogos específicos (anti-CCP).'
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      'Vacúolos, corpos de Heinz e Howell-Jolly.',
      'Corpos de Heinz, Howell-Jolly e hastes de Auer.',
      'Corpúsculos de Döhle, vacúolos e corpos de Heinz.'
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'Agonista nicotínico vasodilatador.',
      'Antagonista muscarínico broncodilatador.',
      'Antagonista beta-adrenérgico.',
      'Agonista colinérgico reductor de muco.'
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Hipersensibilidade tipo 3 com Th1 e IgG.',
      'Hipersensibilidade tipo 2 mediada por Ag-Ac.',
      'Hipersensibilidade mediada por Th1 e citocinas inflamatórias.',
      'Resposta Th2 indutora de IgE e recrutamento de eosinófilos.'
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      'Leucemia linfocítica crônica (linfócitos B maduros incompetentes).',
      'Mieloma múltiplo (plasmócitos clonais).',
  ...
  },
  {
    ...
    options: [
      'Diminuição da pressão de enchimento e da resistência periférica.',
      'Aumento da pressão de enchimento, taquicardia e aumento da pré-carga.',
      'Aumento da resistência periférica e diminuicao do débito.',
      'Taquiarritmia com aumento do relaxamento diastólico.'
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Corticoide e diurético de alça.',
      'Corticoide e tiazídico.',
      'AINE e uricosúricos.'
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'Leucocitose, VHS aumentado e hipercomplementenemia.',
      'Leucopenia, VHS normal e hematúria.',
      'Leucocitose, VHS normal e hipocomplementenemia.',
      'Leucopenia, VHS aumentado, hipocomplementenemia e proteinúria.'
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "empagliflozina.",
      "digoxina.",
      "hidralazina e mononitrato de isossorbida."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      "Iniciar dieta zero, hidratação e analgesia.",
      "Solicitar ultrassonografia de abdome.",
      "Solicitar tomografia computadorizada de abdome.",
      "Realizar CPRE de urgência.",
      "Solicitar sorologias para hepatites."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      "Radiografia e tratar TB latente se alterada.",
      "Investigar TB com teste rápido molecular e cultura.",
      "Radiografia e tratar TB pulmonar se alterada.",
      "Aguardar 3 semanas de tosse.",
      "Encaminhar para ambiente hospitalar."
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      "Glicemia capilar de 127 mg/dL.",
      "Hemoglobina glicada de 5,8%.",
      "TTGO 2h de 157 mg/dL.",
      "Glicemia randômica de 254 mg/dL.",
      "TTGO 1h de 210 mg/dL."
    ],
    correctAnswer: 4,
  ...
  },
  {
    ...
    options: [
      "pressão de pulso < 10%",
      "volume sistólico > 12%",
      "pressão sistólica = 5mmHg",
      "pressão de pulso < 12,5%"
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "insuficiência renal",
      "hipotireoidismo",
      "história de alergia prévia ao meio de contraste"
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "Manter no PS para seriar ECG e troponina.",
      "Angio-TC ambulatorial.",
      "Trombólise imediata."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      "Melhora com albumina confirma SHR.",
      "Manter diuréticos.",
      "Aumentar aporte hídrico.",
      "Hemodiálise imediata.",
      "Exclusão de componente pós-renal (obstrução)."
    ],
    correctAnswer: 4,
  ...
  },
  {
    ...
    options: [
      "Antibiótico profilático e alta.",
      "Betabloqueador e alta.",
      "Betabloqueador e antibiótico se tiver ascite.",
      "Vasoconstritor por 3-5 dias e antibiótico profilático."
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      "confecção de gastrostomia endoscópica.",
      "punção de lesão sólida via ecoendoscopia.",
      "EDA diagnóstica em cirrótico.",
      "colonoscopia em valvulopata."
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      "dosar anticorpos adrenais.",
      "realizar ressonância magnética da hipófise.",
      "realizar TC das adrenais.",
      "dosar 17-hidroxiprogesterona."
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      "tamponamento cardíaco / não usar heparina na diálise.",
      "IAM / retirada lenta de volume.",
      "TEP / heparina subcutânea.",
      "embolia aérea / cata-bolhas."
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      "Hiperproliferativa.",
      "Hemolítica.",
      "Hipoproliferativa e ferropriva.",
      "Megaloblástica.",
      "Normoproliferativa."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      "C3, C4, anti-DNA e proteinúria.",
      "anti-La e biópsia de pele.",
      "P-ANCA e biópsia medular.",
      "anti-histona e BAAR.",
      "apenas hidratação."
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      "Apixabana.",
      "Rivaroxabana.",
      "Heparina e apixabana.",
      "Heparina e varfarina (Marevan).",
      "Aspirina."
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      "Monitorar e dar alta.",
      "Aguardar hemograma.",
      "Antibiótico antipseudomonas imediato.",
      "Azitromicina oral."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      "Levotiroxina imediata.",
      "Ultrassonografia tireoide.",
      "Monitorizar TSH a cada 6-12 meses.",
      "Repetir exames e tratar se TSH > 5."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      "aumento no fluxo sanguíneo renal",
      "redução na secreção de renina",
      "aumento da liberação de vasopressina",
  ...
  },
  {
    ...
    options: [
      ...
      "escamoso e de outro sítio",
      "adenocarcinoma e escamoso",
      "pequenas células e escamoso"
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "trombose arterial do que venosa.",
      "heparina não fracionada (HNF) do que HBPM.",
      "casos clínicos do que cirúrgicos."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      "Indicado bicarbonato se pH 7,28.",
      "Tratar potássio corrige le pH.",
      "Risco de hipoglicemia pós-insulina é maior.",
      "Furosemida altera gasometria.",
      "Gluconato só se tiver alteração no ECG."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      "PBE confirmada.",
      "Bacterascite (não tratar).",
      "Ascite neutrofílica (tratar como PBE).",
      "Exsudato por peritonite secundária.",
      "Transudato."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      "Achados de eco corroboram hipótese.",
      "Sem critérios de IC.",
      "Eco não auxilia.",
      "Achados afastam IC.",
      "Sugerem cor pulmonale."
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      "anti-ro, centromero, anti-sm.",
      "anticardiolipina, antibeta 2 e anticoagulante lúpico.",
      "anticoagulante lúpico, microglobulina, anti-la.",
      "anticoagulante, microglobulina, anti-ro.",
      "anticoagulante, centromero, anti-p."
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "gamopatia monoclonal (ex: Mieloma).",
      "lúpus eritematoso.",
  ...
  },
  {
    ...
    options: [
      "pensamento desorganizado e desatenção.",
      "modificação aguda e apatia.",
      "desatenção e dependência.",
      "modificação aguda do estado e desatenção."
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: "Doença Renal Aguda (DRA) é a fase entre a leção aguda (<7 dias) e a crônica (>3 meses)."
  },
  {
    id: "cl95",
    institution: "UNESP",
    ...
    options: [
      "Hipertensão acelerada; manejo oral.",
      "Hipertensão maligna; vasodilatador IV.",
      "Hipertensão resistente; manejo oral.",
      "Hipertensão resistente; vasodilatador IV."
    ],
    correctAnswer: 1,
    explanation: "Emergência hipertensiva (leção aguda de órgão-alvo) exige internação e medicação parenteral."
  },
  {
    id: "cl96",
    institution: "UNESP",
    ...
    options: [
      "Azitromicina ambulatorial.",
      "Azitromicina ambulatorial.",
      "Betalactâmico + macrolídeo e internação.",
      "Betalactâmico + macrolídeo ambulatorial."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      "Aguarda resolução espontânea.",
      "Aciclovir tópico.",
      "Aciclovir oral e analgesia."
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      "compressões e epinefrina.",
      "desfibrilação, compressões, desfibrilação, epinefrina.",
      "intubação e compressões.",
      "desfibrilação e amiodarona."
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      "IECA.",
      "Espironolactona.",
      "Inibidor da SGLT2 (Gliflozina).",
      "Tratar apenas comorbidades."
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: "Alternativa (C). O histórico de contato/arranhadura por felino associado a lesões linfocutâneas (nódulos e úlceras) e o achado histopatológico de corpos asteroides (fenômeno de Splendore-Hoeppli) são característicos da esporotricose. O tratamento padrão de escolha para a forma linfocutânea é o antifúngico itraconazol."
  },
  {
    id: "cl103",
    institution: "ENAMED",
    ...
    correctAnswer: 1,
    explanation: "Alternativa (B). A poliartrite simétrica envolvendo pequenas articulações das mãos com rigidez matinal prolongada (neste caso, superior a 2 horas) é a apresentação clínica clássica da artrite reumatoide. O diagnóstico laboratorial é apoiado pela presença do fator reumatoide (FR) e o tratamento modificador da doença de primeira linha é o metotrexato."
  },
  {
    id: "cl104",
    institution: "ENAMED",
    ...
    correctAnswer: 0,
    explanation: "Alternativa (A). O paciente apresenta uma Síndrome Nefrótica, definida pela tríade de edema, proteinúria na faixa nefrótica (superior a 3,5 g/24h em adultos) e hipoalbuminemia (neste caso, 1,8 g/dL). A hiperlipidemia (triglicerídeos elevados) é um achado comum, mas não é critério essencial para a definição sindrômica básica como os dois primeiros."
  },
  {
    id: "cl105",
    institution: "ENAMED",
    ...
    correctAnswer: 0,
    explanation: "Alternativa (A). A paciente apresenta critérios de instabilidade hemodinâmica e desnutrição grave decorrentes de um transtorno alimentar: hipotensão severa (80x60 mmHg), bradicardia (55 bpm), IMC muito baixo (14,7) e alterações eletrocardiográficas. Tais achados configuram uma urgência clínica que necessita de internação em enfermaria de clínica médica para estabilização e suporte nutricional seguro."
  },
  {
    id: "cl106",
    institution: "ENAMED",
    ...
    options: [
      ...
      "propranalol e amantadina.",
      "atorvastatina e baclofeno."
    ],
    correctAnswer: 0,
    explanation: "Alternativa (A). O quadro clínico composto por bradicinesia (lentidão), tremor de repouso, rigidez em \"roda dentada\" e instabilidade postural é o diagnóstico clássico de Doença de Parkinson. O tratamento farmacológico inicial padrão-ouro para o controle eficaz dos sintomas motores é a associação de levodopa e carbidopa."
  },
  {
    id: "cl107",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Homem de 34 anos se dirige à Unidade Básica de Saúde (UBS) com febre (38,5 °C), dores de moderada intensidade e manchas no corpo há 3 dias. No dia da consulta, iniciou com dores abdominais e vômitos incontroláveis. Exame físico: prostrado, mucosas coradas, extremidades bem perfundidas. Pressão arterial de 120 x 80 mmHg; frequência respiratória de 16 irpm; frequência cardíaca de 80 bpm. Leve dor à palpação abdominal, sem outras alterações. Qual a hipótese diagnóstica e o manejo, respectivamente?",
    options: [
      "Dengue grupo B. Prescrever hidratação oral, analgésico e antiemético; realizar acompanhamento domiciliar.",
      "Dengue grupo C. Prescrever hidratação oral, analgésico e antiemético; realizar acompanhamento ambulatorial.",
      "Dengue grupo C. Prescrever hidratação parenteral, analgésico e antiemético; manter em leito de observação até estabilização.",
      "Dengue grupo B. Prescrever hidratação parenteral, analgésico e antiemético; manter em leito de observação até estabilização."
    ],
    correctAnswer: 2,
    explanation: "Alternativa (C). A presença de sinais de alerta (dor abdominal intensa e vômitos persistentes) em um paciente com suspeita de dengue o classifica como Dengue Grupo C. Segundo o protocolo do Ministério da Saúde, esses pacientes exigem hidratação parenteral imediata (venosa) e monitoramento em leito de observação hospitalar."
  },
  {
    id: "cl108",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Homem de 68 anos, em tratamento crônico irregular de hipertensão arterial sistêmica, diabetes mellitus e fibrilação atrial, é admitido em Unidade de Pronto Atendimento (UPA) com quadro de rebaixamento do nível de consciência e déficit neurológico do lado esquerdo, de predomínio braquiofacial. Foi levado ao hospital, onde deu entrada 30 minutos após constatado o déficit focal. A tomografia computadorizada de crânio sem contraste revela área de atenuação de densidade em cerca de 40% do território da artéria cerebral média direita, cujo laudo é obtido cerca de 3 horas após o último momento em que o paciente foi visto sem déficits. O médico da unidade explica ao acompanhante que... o paciente apresenta contraindicação [à trombólise] em função de:",
    options: [
      "apresentar extensão de isquemia superior a 1/3 do território da artéria cerebral média acometida.",
      "haver decorrido período de tempo superior ao limite máximo tolerável desde o início do déficit.",
      "evoluir com glicemia acima de 200 mg/dL com intervalo maior que 2 horas pós-prandial.",
      "ter níveis pressóricos superiores aos permitidos para o uso do fármaco."
    ],
    correctAnswer: 0,
    explanation: "Alternativa (A). Embora o paciente esteja dentro da janela de tempo para trombólise (3 horas), o achado de imagem mostrando uma isquemia extensa (mais de 1/3 ou 33% do território da artéria afetada) é uma contraindicação absoluta ao procedimento. Isso ocorre devido ao risco inaceitavelmente alto de transformação hemorrágica grave do infarto."
  },
  {
    id: "cl109",
    institution: "ENAMED",
    ...
    correctAnswer: 2,
    explanation: "Alternativa (C). A paciente apresenta hipotensão ortostática significativa (queda de 28 mmHg na pressão sistólica ao sentar), que é uma causa evitável e perigosa de quedas em idosos. A conduta prioritária é a revisão e desprescrição (revisão da polifarmácia) de fármacos que contribuem para esse quadro, como anti-hipertensivos e diuréticos em excesso."
  },
  {
    id: "cl110",
    institution: "ENAMED",
    ...
    options: [
      ...
      "cetoacidose diabética; prescrever solução fisiológica a 0,9 por cento.",
      "insuficiência renal aguda; prescrever bicarbonato de sódio."
    ],
    correctAnswer: 2,
    explanation: "Alternativa (C). Os critérios de glicemia elevada (> 250 mg/dL), acidose (pH < 7,3) e bicarbonato baixo (< 15 mEq/L) em um paciente com DM1 confirmam o diagnóstico de cetoacidose diabética. A primeira medida terapêutica essencial é a reposição volêmica vigorosa com solução fisiológica a 0,9%."
  },
  {
    id: "cl111",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Homem de 32 anos apresenta quadro de dor lombar crônica de início insidioso, com duração aproximada de 6 meses, que piora pela manhã e melhora com o movimento. Refere rigidez matinal, principalmente nas regiões lombar e sacroilíaca, com duração de mais de 30 minutos. O painel de autoanticorpos apresenta: HLA-B27 Positivo e Fator Reumatoide Negativo. Com base no caso clínico e nos exames laboratoriais apresentados, qual é o diagnóstico mais provável?",
    options: [
      "Artrite reativa.",
      "Artrite psoriática.",
    ...
    correctAnswer: 2,
    explanation: "Alternativa (C). O padrão de dor lombar inflamatória (piora no repouso, melhora no movimento e rigidez matinal prolongada) em um homem jovem, associado à positividade do antígeno HLA-B27, define o diagnóstico de espondilite anquilosante."
  },
  {
    id: "cl112",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Homem de 55 anos, com diagnóstico de diabetes mellitus, faz uso de metformina 850 mg, 3 vezes ao dia, e glicazida 30 mg, 1 vez ao dia, há mais de 6 meses. Os exames laboratoriais atuais apresentam hemoglobina glicada de 9,5% e creatinina sérica de 0,8 mg/dL. Qual das condutas é a mais adequada para o seguimento desse caso?",
    options: [
      "Suspender os medicamentos orais, iniciar insulina NPH manhã e noite.",
      "Aumentar as doses dos orais e repetir exames em 1 mês.",
      "Manter a dose de metformina e glicazida, iniciar insulina NPH 10 UI subcutânea à noite, com ajuste gradual.",
      "Trocar a glicazida por glibenclamida e aumentar a metformina."
    ],
    correctAnswer: 2,
    explanation: "Alternativa (C). Quando um paciente com DM2 não atinge as metas de controle (HbA1c > 9%) sob dose otimizada de dois fármacos orais, a recomendação é a insulinização basal. Inicia-se habitualmente com 10 UI de insulina NPH ao deitar (noite), mantendo a medicação oral prévia para sensibilização."
  },
  {
    id: "cl113",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Homem de 38 anos retorna a ambulatório de clínica médica onde faz acompanhamento de retocolite ulcerativa. O médico observa elevações significativas da fosfatase alcalina e gama-GT, com discreta elevação de aminotransferases, sem hiperbilirrubinemia. O paciente refere apenas leve desconforto no hipocôndrio direito; não há icterícia ou febre. Considerando a doença de base do caso, o exame complementar indicado e seu resultado provável são, respectivamente:",
    options: [
      "tomografia computadorizada; lesão tumoral ao nível do hilo hepático.",
      "colangiopancreatografia retrógrada endoscópica; litíase impactada no colédoco terminal.",
      "colangiorressonância; múltiplas estenoses intercaladas na árvore biliar, com áreas normais ou dilatadas de permeio.",
      "ultrassonografia abdominal total; espessamento da parede da vesícula biliar com nodulação no interior."
    ],
    correctAnswer: 2,
    explanation: "Alternativa (C). A associação entre doenças inflamatórias intestinais e um perfil laboratorial de colestase sugere fortemente Colangite Esclerosante Primária (CEP). O exame diagnóstico padrão-ouro é a colangiorressonância, que demonstra o padrão biliar em \"contas de rosário\" (estenoses e dilatações multifocais)."
  },
  {
    id: "cl114",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Mulher de 45 anos é internada com queixas de febre (38 °C), mialgia, mal-estar e dor na região cervical anterior, irradiada para a mandíbula e orelhas. Há 2 semanas, iniciou quadro de infecção viral respiratória alta. Passou a sentir palpitações e tremores nos últimos 3 dias. À palpação da tireoide: glândula dolorosa, firme e levemente aumentada; VHS e PCR elevados. Considerando a principal hipótese diagnóstica para o caso, quais exames complementares a sustentariam e qual o tratamento indicado, respectivamente?",
    options: [
      "Redução da captação tireoidiana de iodo radioativo; betabloqueador e anti-inflamatório.",
      "Presença de nódulo quente à cintilografia; tireoidectomia subtotal.",
      "Aumento de TSH, T4 livre e TRAb; ablação com iodo radioativo.",
      "Verificação de aumento das concentrações sanguíneas de TSH, T3 e T4 livre; oseltamivir + metimazol."
    ],
    correctAnswer: 0,
    explanation: "Alternativa (A). O quadro clínico de dor cervical pós-viral e sintomas transitórios de hipertireoidismo é compatível com Tireoidite Subaguda (de Quervain). O diagnóstico é sustentado pela baixa captação de iodo (a glândula inflamada não produz hormônio, apenas libera o estocado) e o tratamento foca no alívio de sintomas com anti-inflamatórios e betabloqueadores."
  },
  {
    id: "cl115",
    institution: "ENAMED",
    ...
    correctAnswer: 0,
    explanation: "Alternativa (A). A ocorrência de eventos trombóticos em pacientes jovens e com forte histórico familiar sugere uma trombofilia hereditária. A Presença do Fator V de Leiden é a causa genética mais prevalente para esse estado de hipercoagulabilidade."
  },
  {
    id: "cl116",
    institution: "ENAMED",
    ...
    options: [
      ...
      "o tipo e a classe de substância que o paciente usa, se é lícita ou ilícita."
    ],
    correctAnswer: 2,
    explanation: "Alternativa (C). De acordo com os critérios diagnósticos do DSM-5 para transtornos por uso de substâncias, dedicar uma grande quantidade de tempo em atividades para obter o álcool, consumi-lo ou recuperar-se de seus efeitos é um dos marcadores centrais do transtorno."
  },
  {
    id: "cl117",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Homem de 35 anos, índice de massa corporal de 15 kg/m², é internado devido à diarreia líquida, flatulência e desconforto abdominal há 4 semanas, com perda de 10 kg. Endoscopia digestiva alta e baixa sem alterações macroscópicas e histopatológicas. Teste respiratório com lactulose positivo. O plano terapêutico adequado para esse paciente será:",
    options: [
    ...
    correctAnswer: 0,
    explanation: "Alternativa (A). O resultado positivo no teste do hidrogênio expirado (lactulose) em um paciente com síndrome de má absorção e exames endoscópicos normais confirma o diagnóstico de Superprocedimento Bacteriano no Intestino Delgado (SIBO). O tratamento consiste na erradicação do excesso bacteriano com antibióticos de ação luminal, como a rifaximina e neomicina."
  },
  {
    id: "cl118",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Mulher de 62 anos, com histórico de infecções do trato urinário de repetição, dá entrada em UPA com quadro de febre alta e calafrios. É portadora de diabetes mellitus tipo 2. À admissão apresenta-se com pressão arterial de 110 x 70 mmHg, frequência cardíaca de 106 bpm, frequência respiratória de 25 irpm. Leucócitos de 14.000/mm³ com 12% de bastonetes. A conduta para o caso deve ser recomendar:",
    options: [
      "tratamento com antitérmico, hidratação oral vigorosa e observação.",
      "tratamento com esquema antibiótico de amplo espectro, ainda na 1ª hora da chegada da paciente.",
      "tratamento com cobertura contra Candida sp.",
      "tratamento com antibiótico de amplo espectro mantido mesmo após resultados das culturas."
    ],
    correctAnswer: 1,
    explanation: "Alternativa (B). A paciente preenche critérios clínicos para sepse (foco infeccioso provável em trato urinário associado a disfunção orgânica ou sinais de resposta inflamatória sistêmica grave). O protocolo de \"Hora de Ouro\" da sepse preconiza o início da antibioticoterapia de amplo espectro na primeira hora para reduzir o risco de óbito."
  },
  {
    id: "cl119",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Mulher de 55 anos queixa-se de cefaleia persistente bilateral, amaurose fugaz, diplopia, artralgia e dor em todo o couro cabeludo, com perda de peso (2 kg em 2 meses). Ao exame, afebril, pupilas isocóricas e sem rigidez de nuca. Qual é o tipo de cefaleia dessa paciente, e qual exame seria útil na sua investigação preliminar, respectivamente?",
    options: [
      "Cefaleia primária (cefaleia tensional); nenhum exame é necessário.",
      "Cefaleia secundária (hemorragia subaracnoideia); análise de líquor.",
      "Cefaleia primária (migrânea); tomografia computadorizada de encéfalo.",
      "Cefaleia secundária (arterite temporal); velocidade de hemossedimentação."
    ],
    correctAnswer: 3,
    explanation: "Alternativa (D). O quadro de cefaleia em paciente acima de 50 anos associado a alterações visuais e hipersensibilidade do couro cabeludo (claudicação de mandíbula é comum, embora não citada aqui) é sugestivo de Arterite Temporal (Arterite de Células Gigantes). O exame de triagem inicial mais sensível é a velocidade de hemossedimentação (VHS) elevada."
  },
  {
    id: "cl120",
    institution: "ENAMED",
    year: 2025,
    specialty: "Clinica",
    text: "Homem de 56 anos, em acompanhamento por angina instável, DM2, HAS e dislipidemia, é internado com dor torácica intensa irradiada para o braço esquerdo e mandíbula há 2 horas. ECG mostra novo infradesnivelamento de ST de 1 mm e inversão de onda T. Evoluiu com elevação de troponina-I. O escore Grace é de 152 pontos e o TIMI é de 5 pontos. A conduta indicada nesse caso é realizar:",
    options: [
      "angiotomografia coronária em até 48 horas.",
      "cateterismo cardíaco nas primeiras 24 horas.",
      "cateterismo cardíaco em até 3 dias do evento.",
      "ecocardiograma de estresse em até 7 dias do evento."
    ],
    correctAnswer: 1,
    explanation: "Alternativa (B). O paciente apresenta um Infarto Agudo do Miocárdio sem supradesnivelamento de ST (IAMSSST) classificado como de alto risco (Grace > 140). Para esses casos, as diretrizes nacionais e internacionais recomendam uma estratégia invasiva precoce, com a realização do cateterismo cardíaco nas primeiras 24 horas da admissão."
  }
];
